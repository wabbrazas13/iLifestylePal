...
public class FindFriendsFriendsFragment extends Fragment {
    ...
    private FindFriendsFriendsAdapter mFriendListAdapter;

    public FindFriendsFriendsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_find_friends_friends, container, false);
        ...
        mRecyclerView = view.findViewById(R.id.rv_friends_list);
        mSearchField = view.findViewById(R.id.sv_search);

        mFriendListAdapter = new FindFriendsFriendsAdapter(mFriendsList);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot data : snapshot.getChildren()) {
                    if (snapshot.hasChild(currentUserID)
                        ...
                        mFriendsList.add(myDataModel);
                    }
                }

                mFriendListAdapter.notifyDataSetChanged();
                mSearchField.clearFocus();
                mFriendListAdapter.getFilter().filter("");
            }
